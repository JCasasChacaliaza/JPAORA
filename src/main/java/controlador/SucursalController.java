...
import modelo.dao.SucursalFacade;
...
public class SucursalController implements Serializable {
    ...
    @EJB
    private modelo.dao.SucursalFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("SucursalCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("SucursalUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("SucursalDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class SucursalControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sucursal) {
                ...
                return getStringKey(o.getIdsuc());
            } else {
