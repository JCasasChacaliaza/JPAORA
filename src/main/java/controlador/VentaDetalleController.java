...
import modelo.dao.VentaDetalleFacade;
...
public class VentaDetalleController implements Serializable {
    ...
    @EJB
    private modelo.dao.VentaDetalleFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("VentaDetalleCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("VentaDetalleUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("VentaDetalleDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public VentaDetalle getVentaDetalle(java.math.BigDecimal id) {
